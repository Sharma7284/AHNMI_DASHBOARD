...
const routes: Routes = [
  ...
  { path: 'pages-membership-form', component: PagesMembershipFormComponent },
  ...
  { path: 'pages-regulatory', component: PagesRegulatoryComponent },
  { path: 'pages-policy-adovcacy', component: PagesPolicyAdovcacyComponent },
  { path: 'pages-view-policy-adovcacy', component: PagesViewPrivacyPolicyComponent },
  { path: 'pages-view-policy-adovcacy/:id', component: PagesViewPrivacyPolicyComponent },
  { path: 'pages-regulaltory-support', component: PagesRegulatorySupportComponent },
  { path: 'pages-regulaltory-support/:id', component: PagesRegulatorySupportComponent },
  { path: 'pages-schemes-and-subsidies', component: PagesSchemesAndSubsidiesComponent },
  { path: 'pages-schemes-and-subsidies/:id', component: PagesSchemesAndSubsidiesComponent },
  { path: 'pages-schemes-and-subsidies/:id/:sid', component: PagesSchemesAndSubsidiesComponent },
  { path: 'pages-our-services', component: PagesOurServicesComponent },
